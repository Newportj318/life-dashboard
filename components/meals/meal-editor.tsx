    ...
    <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
      <div className="space-y-6 xl:col-span-2">
        ...
        <section className="surface p-6">
          ...
          <div className="mt-6 border-t border-gray-100 dark:border-white/[0.08] pt-4">
            {!showExtra ? (
...
function FoodSearch({ onAdd }: { onAdd: (food: FoodDraft) => void }) {
  ...
  return (
    <div>
      ...
      {showResults && (
        <div className="mt-2 max-h-80 overflow-y-auto rounded-lg border border-gray-200 dark:border-white/[0.08]">
      ...
      {!manual ? (
        ...
        <div className="mt-3 rounded-lg border border-gray-200 dark:border-white/[0.08] p-4">
